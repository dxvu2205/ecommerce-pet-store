    ...
    return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="text-center text-lg font-semibold leading-8 text-gray-900">
         Chúng tôi được tin tưởng và có mặt trên nhiều phương tiện truyền thông
        </h2>
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          ...
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
            src="https://cdn.brvn.vn/editor/2022/01/A33_YouTube-1_1641887326.jpeg"
            alt="Reform"
            width={158}
            height={48}
          />
          ...
          <img
            ...
            src="https://yt3.googleusercontent.com/ytc/AL5GRJU7mi8Rj0Hp805OsRjvzeuRIyV14iawzJI1JPjcHno=s900-c-k-c0x00ffffff-no-rj"
            alt="Statamic"
            width={158}
            height={48}
          />
            ...
            <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-amber-300 lg:justify-between">
                <div className="mr-12 hidden lg:block">
                    <span>Get connected with us on social networks:</span>
                </div>
                <div className="flex justify-center">
                    <a href="#!" className="mr-6 text-amber-500 dark:text-neutral-200">
                    ...
                    <a href="#!" className="text-amber-500 dark:text-neutral-200">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div className>
                        <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start text-amber-500">
                    ...
                    <div className>
                        <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start text-amber-500">
                            Products
                        </h6>
                        <p className="mb-4">
